...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_crawl.add_argument("--sleep", type=float, default=0.4, help="İstekler arası bekleme saniyesi")
    ...
    p_daily.add_argument("--timeout", type=int, default=60)
    p_daily.add_argument("--retries", type=int, default=2, help="Her URL için deneme sayısı")
    p_daily.add_argument("--max-request-seconds", type=int, default=180, help="Tek URL için toplam süre sınırı")
    p_daily.add_argument("--sleep", type=float, default=0.4, help="İstekler arası bekleme saniyesi")
    p_daily.add_argument("--empty-day-retries", type=int, default=2, help="Bir gün 0 belge dönerse kaç kez tekrar denensin?")
    p_daily.add_argument("--empty-day-sleep", type=float, default=8.0, help="Boş gün tekrarları arasında bekleme saniyesi")
